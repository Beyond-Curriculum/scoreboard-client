    ...
    return (
        <footer className={classes.Footer}>
            <div className="container">
                ...
                <a href="https://beyondcurriculum.kz"><img src={beyond} height={32} alt="BeyondCurriculum" /></a>
                <div className={classes.flex}>
                    <div className={classes.copyright}>© <a href="https://beyondcurriculum.kz">BeyondCurriculum</a> 2020</div>
                    <a className={classes.link} href="https://beyondcurriculum.kz/donate">{l.support + " "}<span aria-label="heart" role="img">❤️</span></a>
                </div>
            </div>
        </footer>
    );
